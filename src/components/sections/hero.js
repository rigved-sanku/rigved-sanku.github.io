...
const Hero = () => {
  ...
  const two = <h2 className="big-heading">Rigved Sanku.</h2>;
  const three = <h3 className="big-heading">I help robots see</h3>;
  const four = (
    <>
      <p>
  ...
  const five = (
    <a className="email-link" href="mailto:rigvedsanku@gmail.com" target="_blank" rel="noreferrer">
      Get in touch!
    </a>
  );
